...
coffeemachineInsert(Poststate4, Prearg5, Poststate5, Postarg5, Return5),
...
coffeemachineInsert(Poststate5, Prearg6, Poststate6, Postarg6, Return6),
...
coffeemachineInsert(Poststate6, Prearg7, Poststate7, Postarg7, Return7),
...
coffeemachineInsert(Poststate7, Prearg8, Poststate8, Postarg8, Return8),
...
coffeemachineDone(Poststate8, Prearg9, Poststate9, Postarg9, Return9),
Pres8 = [Poststate8],
Prea8 = [Prearg9],
Posts8 = [Poststate9],
Posta8 = [Postarg9],
